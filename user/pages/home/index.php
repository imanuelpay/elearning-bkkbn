                    ...
                    <ul>
                        <li>
                            <div class="singel-event">
                                ...
                                <span><i class="fa fa-user"></i> Rc Auditorim</span>
                            </div>
                        </li>
                    </ul>
                </div> <!-- event 2 -->
                ...
                <div class="category-form">
                    ...
                    <div class="main-form">
                        <form action="#">
                            ...
                            <div class="singel-form">
                                <input type="password" placeholder="Kata sandi anda">
                            </div>
                            <div class="singel-form">
                                <button class="main-btn" type="button">Masuk</button>
                            </div>
                            <div class="singel-form">
        ...
        <div class="row course-slied mt-10">
            <div class="col-lg-4">
                <div class="singel-course-2">
                    <div class="thum">
                        <div class="image">
                            <img src="./assets/user/images/course/cu-1.jpg" alt="Course">
                        </div>
                        <div class="price">
                            <span>Free</span>
                        </div>
                        <div class="course-teacher">
                            <div class="thum">
                                <a href="courses-singel.html"><img src="./assets/user/images/course/teacher/t-1.jpg"
                                                                   alt="teacher"></a>
                            </div>
                            <div class="name">
            ...
            <div class="col-lg-6">
                <div class="singel-news mt-30">
                    <div class="news-thum pb-25">
                        <img src="./assets/user/images/news/n-1.jpg" alt="News">
                    </div>
                    <div class="news-cont">
                        <ul>
            ...
            <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="news-thum mt-30">
                                <img src="./assets/user/images/news/ns-1.jpg" alt="News">
                            </div>
                        </div>
                        <div class="col-sm-8">
                ...
                <div class="singel-news news-list">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="news-thum mt-30">
                                <img src="./assets/user/images/news/ns-2.jpg" alt="News">
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="news-cont mt-30">
                ...
                <div class="singel-news news-list">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="news-thum mt-30">
                                <img src="./assets/user/images/news/ns-3.jpg" alt="News">
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="news-cont mt-30">
